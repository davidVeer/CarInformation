...
public class NegativeMeanTest extends NegativeValues implements CalculatorMeanTest {
	...
	public void refuelNumberMean() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.meanRefuelTank(InformationType.REFUEL_NUMBER));
	...
	public void drivenKilometersMean() {
		super.setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.meanRefuelTank(InformationType.KILOMETERS_DRIVEN));
	...
	public void litersMean() {
		super.setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.meanRefuelTank(InformationType.LITERS));
	...
	public void refuelPriceMean() {
		super.setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.meanRefuelTank(InformationType.REFUEL_PRICE));
	...
	public void LiterPriceMean() {
		setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.meanRefuelTank(InformationType.LITER_PRICE));
	...
	public void kilometersPerLiterMean() {
		setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.meanRefuelTank(InformationType.KILOMETERS_PER_LITER));
