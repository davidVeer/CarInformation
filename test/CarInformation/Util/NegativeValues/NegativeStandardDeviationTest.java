...
public class NegativeStandardDeviationTest extends NegativeValues implements CalculatorStandardDeviation {
	...
	public void refuelNumberStandardDeviation() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.populationStandardDeviationRefuelTank(InformationType.REFUEL_NUMBER));
	...
	public void drivenKilometersStandardDeviation() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.populationStandardDeviationRefuelTank(InformationType.KILOMETERS_DRIVEN));
	...
	public void litersStandardDeviation() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.populationStandardDeviationRefuelTank(InformationType.LITERS));
	...
	public void refuelPriceStandardDeviation() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.populationStandardDeviationRefuelTank(InformationType.REFUEL_PRICE));
	...
	public void LiterPriceStandardDeviation() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.populationStandardDeviationRefuelTank(InformationType.LITER_PRICE));
	...
	public void kilometersPerLiterStandardDeviation() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.populationStandardDeviationRefuelTank(InformationType.KILOMETERS_PER_LITER));
