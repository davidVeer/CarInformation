...
public class NegativeTotalTest extends NegativeValues implements CalculatorTotalTest {
	...
	public void refuelNumberTotal() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.totalValueRefuelTank(InformationType.REFUEL_NUMBER));
	...
	public void drivenKilometersTotal() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.totalValueRefuelTank(InformationType.KILOMETERS_DRIVEN));
	...
	public void litersTotal() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.totalValueRefuelTank(InformationType.LITERS));
	...
	public void refuelPriceTotal() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.totalValueRefuelTank(InformationType.REFUEL_PRICE));
	...
	public void LiterPriceTotal() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.totalValueRefuelTank(InformationType.LITER_PRICE));
	...
	public void kilometersPerLiterTotal() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.totalValueRefuelTank(InformationType.KILOMETERS_PER_LITER));
