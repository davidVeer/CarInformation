...
public class NegativeModeTest extends NegativeValues implements CalculatorModeTest {
	...
	public void refuelNumberMode() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.modeRefuelTank(InformationType.REFUEL_NUMBER));
	...
	public void drivenKilometersMode() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.modeRefuelTank(InformationType.KILOMETERS_DRIVEN));
	...
	public void litersMode() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.modeRefuelTank(InformationType.LITERS));
	...
	public void refuelPriceMode() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.modeRefuelTank(InformationType.REFUEL_PRICE));
	...
	public void LiterPriceMode() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.modeRefuelTank(InformationType.LITER_PRICE));
	...
	public void kilometersPerLiterMode() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.modeRefuelTank(InformationType.KILOMETERS_PER_LITER));
