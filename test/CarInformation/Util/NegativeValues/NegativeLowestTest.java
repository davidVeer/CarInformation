...
public class NegativeLowestTest extends NegativeValues implements CalculatorLowestTest {
	...
	public void refuelNumberLowest() {
		...
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.lowestRefuelTank(InformationType.REFUEL_NUMBER));
	...
	public void drivenKilometersLowest() {
		super.setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.lowestRefuelTank(InformationType.KILOMETERS_DRIVEN));
	...
	public void litersLowest() {
		super.setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.lowestRefuelTank(InformationType.LITERS));
	...
	public void refuelPriceLowest() {
		super.setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.lowestRefuelTank(InformationType.REFUEL_PRICE));
	...
	public void LiterPriceLowest() {
		setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.lowestRefuelTank(InformationType.LITER_PRICE));
	...
	public void kilometersPerLiterLowest() {
		setup();
		NullPointerException expectedException = assertThrows(NullPointerException.class ,() ->
				calculator.lowestRefuelTank(InformationType.KILOMETERS_PER_LITER));
